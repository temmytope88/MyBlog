         ...
         // check  for any error in the users input
          if ($count > 0){
             ...
             {     
                ...
                $query = "SELECT email FROM bloggers WHERE email = '$email'";
                ...
                if($result)
                    ...
                    {
											$sql = "INSERT INTO bloggers (firstname, surname, email, passcode, gender) VALUES (:firstname, :surname, :email, :passcode, :gender)";
